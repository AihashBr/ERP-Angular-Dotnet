...
public interface IAuthRepository
{
    ...
    /// </summary>
    /// <param name="userName">User Name do usuário para autenticação.</param>
    /// <param name="password">Senha em texto puro que será verificada com o hash armazenado.</param>
    /// <returns>
    /// Retorna o <see cref="User"/> autenticado se o user name e a senha estiverem corretos e o usuário estiver ativo;
